...
public class MyAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        timetv.setText(time);
        //king表示类型，MINI_KIND: 512 x 384，MICRO_KIND: 96 x 96
        videoiv.setImageBitmap(getVidoeThumbnil(urlvideo,200,200,
...
//避免超出界外
    ...
    private  Bitmap getVidoeThumbnil(String url,int width,int height,int kind){
        Bitmap bitmap = null;
