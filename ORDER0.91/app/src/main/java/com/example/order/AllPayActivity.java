...
import com.example.order.SuggestionActivity.MyTask;
import com.example.order.SuggestionActivity.ProductAdapter;
...
//	    });	
	...
	public class ProductAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			View view = null;
			if(convertView == null){
				view = LayoutInflater.from(AllPayActivity.this).inflate(R.layout.cooklistview,null);				
			}else {
				view = convertView;
			}
