...
public class Ordered2Activity extends Activity {
...
//	     						   list = adapter.getdate(); 
	     						   ...
	     						   //重启UI以更新
	     						   Intent intent = new Intent(Ordered2Activity.this, Ordered2Activity.class);
...
//				final String R_Name = list.get(position).get("R_Name");
				...
				if (list.get(position).get("O_Cook").toString().equals("1") || list.get(position).get("O_Cook").toString().equals("2")) {
					Toast.makeText(Ordered2Activity.this,"该菜式已经烹饪，不可删除",1).show();
...
//		button.setText("返回");
		button.setBackground(this.getResources().getDrawable(R.drawable.back));
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO 自动生成的方法存根
//				
//				 Intent intent  = new Intent(Ordered2Activity.this,SeatActivity.class);
//					System.out.println("Ordered2Activity----->>"+User_Name);
//					intent.putExtra("User_Name", User_Name);
//					startActivity(intent);
					finish();
...
//						   Intent intent = new Intent(Ordered2Activity.this, EndActivity.class);
//						   intent.putExtra("User_Name", User_Name);
//
//						   startActivity(intent);  
//						   finish();        
...
//					
		...
		public class ProductAdapter extends BaseAdapter{
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				View view = null;
				if(convertView == null){
					view = LayoutInflater.from(Ordered2Activity.this).inflate(R.layout.recipelistview,null);				
				}else {
					view = convertView;
				}
